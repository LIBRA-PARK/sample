...
public class GradleProjectImageService {
    ...
    public void processing(String projectPath) {
    ...
    public void buildContainerImage(String projectPath) throws RuntimeException {
        String os = System.getProperty("os.name").toLowerCase();
        ProcessBuilder processBuilder = os.contains("win")
                ? new ProcessBuilder("cmd.exe", "/c", "gradlew.bat", "jib")
                : new ProcessBuilder("./gradlew jib");
    ...
    public void injectionJibDependency(Path buildFilePath, List<String> buildFileLines) {
    ...
    public void injectionJibConfiguration(Path buildFilePath, List<String> buildFileLines) {
